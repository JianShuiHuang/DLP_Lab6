...
class Net(nn.Module):
    def __init__(self, state_dim=8, action_dim=4, hidden_dim=32):
        ...
        ## TODO ##
        # layer 1
        self.linear_1 = nn.Linear(state_dim, hidden_dim, bias = False)
        ...
        # layer 3
        self.linear_3 = nn.Linear(hidden_dim, action_dim, bias = True)
...
class DQN:
    ...
    def select_action(self, state, epsilon, action_space):
        '''epsilon-greedy based on behavior network'''
         ## TODO ##
        # probability (epsilon/m) to choose behavior
        if random.random() < epsilon:
            return random.randint(0, 3)
        # probability (1 - epsilon/m) to choose max value
        else:
